...
const RootLayout = async ({ children }: { children: ReactNode }) => {
  ...
  return (
    <html lang="en" className={`${inter.variable} ${newsreader.variable}`}>
      ...
      <body className="selection-bg-neutral-800 flex min-h-screen flex-col scroll-smooth leading-loose antialiased dark:bg-neutral-900 dark:text-neutral-200 dark:selection:bg-neutral-800">
